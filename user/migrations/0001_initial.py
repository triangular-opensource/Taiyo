    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gst_number', models.CharField(max_length=16, validators=[services.validators.validate_gst_number])),
                ...
                ('friends', models.ManyToManyField(blank=True, null=True, related_name='_user_user_friends_+', to=settings.AUTH_USER_MODEL)),
